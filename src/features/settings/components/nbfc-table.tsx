...
import { type Nbfc, nbfcData } from '../lib/nbfc-data';
...
export function NbfcTable() {
  ...
  const columnHelper = createColumnHelper<Nbfc>();

  const columns = [
    columnHelper.accessor('name', {
      header: ({ column }) => <DataGridColumnHeader title="NBFC Name" column={column} />,
    ...
    columnHelper.accessor('registrationNumber', {
      header: ({ column }) => <DataGridColumnHeader title="Registration No." column={column} />,
    ...
    columnHelper.accessor('headquarter', {
      header: ({ column }) => <DataGridColumnHeader title="Headquarter" column={column} />,
    ...
    () => [
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'Loan Company', value: 'Loan Company' },
          { label: 'Investment Company', value: 'Investment Company' },
          { label: 'Infrastructure Finance', value: 'Infrastructure Finance' },
        ],
        searchable: true,
        className: 'w-[180px]',
      },
  ...
  const filteredData = useMemo(() => {
    ...
    activeFilters.forEach((filter) => {
      ...
      filtered = filtered.filter((item) => {
        const fieldValue = item[field as keyof Nbfc];
      ...
      <div className="w-full space-y-2.5">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
          <Input
            ...
            placeholder="Search NBFCs..."
            type="text"
            aria-label="Search NBFCs"
          />
